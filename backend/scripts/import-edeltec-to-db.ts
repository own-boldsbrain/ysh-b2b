/**
 * Import Script: Edeltec
 * 
 * Importa produtos do arquivo de catálogo edeltec-catalog-full.json para PostgreSQL
 * 
 * Uso:
...
const DISTRIBUTOR_ID = 'edeltec';
const DISTRIBUTOR_NAME = 'Edeltec';
