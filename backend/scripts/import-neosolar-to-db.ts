/**
 * Import Script: Neosolar
 * 
 * Importa produtos do arquivo de catálogo neosolar-catalog-full.json para PostgreSQL
 * 
 * Uso:
...
const DISTRIBUTOR_ID = 'neosolar';
const DISTRIBUTOR_NAME = 'Neosolar';
