/**
 * Import Script: Solfácil
 * 
 * Importa produtos do arquivo de catálogo solfacil-catalog-full.json para PostgreSQL
 * 
 * Uso:
...
const DISTRIBUTOR_ID = 'solfacil';
const DISTRIBUTOR_NAME = 'Solfácil';
